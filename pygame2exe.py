...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "tankgame.py"
 
        #Name of program
        self.project_name = "TANKGAME"
 
        #Project url
        self.project_url = "https://github.com/tomcola512/tankgame"
        ...
        #Auhor of program
        self.author_name = "Tom Coladonato"
        self.author_email = "tom@coladona.to"
        self.copyright = "Copyright (c) 2014 Tom Coladonato."
 
        #Description
        self.project_description = "Minimal Multiplayer Tank Game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "Pygame.ico"
 
        #Extra files/dirs copied to game
        self.extra_datas = ["beep.ogg", "engine.ogg", "pew.ogg", "pew2.ogg", "whine.ogg"]
